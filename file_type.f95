module file_type
  ...
  type, abstract :: file
     ...
     ! real, allocatable :: section(:)
   contains
     ! procedure(header_reader), deferred :: read_file_header
     ! module procedure read_file_header
     procedure, public :: read_file_header
  end type file


  abstract interface
     ! subroutine header_reader(this, z, ios, MF, MT)
     !   import file
